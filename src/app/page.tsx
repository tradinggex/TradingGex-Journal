    ...
    <div className="min-h-screen bg-[#0d0f1a] text-[#e2e8f0] font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#0d0f1a]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[9px] tracking-[0.2em] uppercase text-[#64748b] mt-0.5">
              Journal
            </span>
          </div>
          <nav className="hidden sm:flex items-center gap-6 text-sm text-[#94a3b8]">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="text-sm font-medium text-[#94a3b8] hover:text-white transition-colors px-3 py-1.5"
            >
              Sign in
            </Link>
            <Link
              href="/register"
              className="text-sm font-semibold bg-purple-600 hover:bg-purple-500 text-white px-4 py-2 rounded-xl transition-all"
            >
              Get Started
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden pt-20 pb-28 px-4 sm:px-6">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-40 left-1/3 w-[400px] h-[300px] bg-purple-800/8 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-[#94a3b8] max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            Log trades, get AI feedback on your patterns, and build the
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-16">
            <Link
              href="/register"
              className="flex items-center gap-2 bg-purple-600 hover:bg-purple-500 text-white font-bold text-base px-8 py-3.5 rounded-2xl transition-all shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:-translate-y-0.5"
            >
              Start Free Trial
            ...
            <Link
              href="/login"
              className="flex items-center gap-2 border border-white/10 text-[#94a3b8] hover:text-white hover:border-white/20 font-medium text-base px-8 py-3.5 rounded-2xl transition-all"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto mt-16 px-4">
          <div className="rounded-2xl border border-white/5 bg-[#141725] p-1 shadow-2xl shadow-black/60">
            <div className="rounded-xl bg-[#0d0f1a] border border-white/5 p-6">
              ...
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/5">
                ...
                <div className="flex gap-2 ml-auto">
                  {["Dashboard", "Trades", "Analytics", "Journal"].map((item) => (
                    <div key={item} className="hidden sm:block text-[11px] text-[#64748b] px-3 py-1 rounded-lg hover:text-white">
                      {item}
                    </div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                {[
                  ...
                  <div key={label} className="bg-[#1c2035] rounded-xl p-3 sm:p-4">
                    <div className="text-[10px] text-[#64748b] uppercase tracking-widest mb-1">{label}</div>
                    <div className={`text-lg sm:text-xl font-bold ${color}`}>{value}</div>
                  </div>
                ))}
              </div>
              {/* Fake chart bars */}
              <div className="bg-[#1c2035] rounded-xl p-4 flex items-end gap-1 h-24">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={title}
                className="group relative rounded-2xl border border-white/5 bg-[#141725] p-6 hover:border-purple-500/25 transition-all hover:shadow-lg hover:shadow-purple-500/5"
              >
                {badge && (
                  <span className="absolute top-4 right-4 text-[10px] font-bold bg-purple-500/20 text-purple-300 px-2 py-0.5 rounded-full border border-purple-500/30">
                    {badge}
                  </span>
                )}
      ...
      <section className="py-10 px-4 border-y border-white/5">
        <div className="max-w-4xl mx-auto flex flex-wrap items-center justify-center gap-8 text-sm text-[#64748b]">
          {[
      ...
      <section id="pricing" className="py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[#94a3b8]">Start free. No credit card required to begin your trial.</p>
          </div>

          <div className="flex flex-col lg:flex-row gap-6 items-stretch justify-center">
            {/* Free trial card */}
            <div className="flex-1 max-w-sm rounded-2xl border border-white/10 bg-[#141725] p-8">
              <div className="text-sm font-semibold text-[#94a3b8] mb-1">Free Trial</div>
              <div className="text-4xl font-black text-white mb-1">$0</div>
              <div className="text-sm text-[#64748b] mb-6">3 days, no credit card needed</div>
            ...
            {/* Pro card */}
            <div className="flex-1 max-w-sm relative rounded-2xl border border-purple-500/40 bg-gradient-to-b from-purple-500/10 to-[#141725] p-8 shadow-xl shadow-purple-500/10">
              {/* Popular badge */}
              ...
              <div className="text-sm text-[#64748b] mb-6">Everything in trial, plus</div>
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={f} className="flex items-center gap-2.5 text-sm text-[#e2e8f0]">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 ${i === 0 ? "bg-purple-500/20 border border-purple-500/40" : "bg-purple-500/20 border border-purple-500/40"}`}>
      ...
      {/* ─── Testimonials ─── */}
      <section id="testimonials" className="py-24 px-4 sm:px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={name} className="rounded-2xl border border-white/5 bg-[#141725] p-6">
                <div className="flex gap-0.5 mb-4">
                  {Array.from({ length: stars }).map((_, i) => (
                    <Star key={i} size={14} className="fill-amber-400 text-amber-400" />
                  ))}
                </div>
                <p className="text-sm text-[#94a3b8] leading-relaxed mb-5">&ldquo;{quote}&rdquo;</p>
                <div className="flex items-center gap-3">
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-2xl mx-auto text-center">
          <div className="relative rounded-3xl border border-purple-500/20 bg-gradient-to-b from-purple-500/10 to-transparent p-12 overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link
                href="/register"
                className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-500 text-white font-bold text-base px-10 py-4 rounded-2xl transition-all shadow-xl shadow-purple-500/30 hover:-translate-y-0.5"
              >
