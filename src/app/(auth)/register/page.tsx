  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="card p-8">
        <h1 className="text-xl font-bold text-foreground mb-1">{t("auth.register.title")}</h1>
        <p className="text-sm text-fg-subtle mb-6">{t("auth.register.description")}</p>
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-xs text-fg-subtle">{t("auth.or")}</span>
          <div className="flex-1 h-px bg-[var(--border)]" />
        </div>
